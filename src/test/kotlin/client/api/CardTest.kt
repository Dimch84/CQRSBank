    ...
    private fun standardInit() {
        if (first) {
            ...
            transaction(db) {
                ...
                account1 = Account.new { userId = user1; planId = simplePlan; money = 1000 }
            }
        }
    }

    private fun getMoney(id: Long) = transaction(db) { Account.findById(id)!!.money }    // TODO(Account fun later)
